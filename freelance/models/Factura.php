...
class Factura extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fac_money' => 'Factura Moneda',
            'cli_id' => 'Cliente',
            'soc_id' => 'Socio',
            'fdp_id' => 'Forma De Pago',
            'fac_estado' => 'Factura Estado',
            'fac_situacion' => 'Factura Situacion',
            'fac_fecha_situacion' => 'Factura Fecha Situacion',
            'fac_subtotal' => 'Factura Subtotal',
            'fac_iva' => 'Factura Iva',
