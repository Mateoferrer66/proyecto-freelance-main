 ...
 * @property int $liq_anulada Indica si la liquidacion se encuentra anulada: 1 - Si, 0 - No
...
class Liquidacion extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['usu_id', 'soc_id', 'liq_exportada', 'liq_transferencia', 'liq_anulada', 'liq_eliminada'], 'integer'],
            [['liq_fecha'], 'safe'],
    ...
    {
        return $this->hasMany(CotizacionLiquidacion::class, ['liq_id' => 'liq_id']);
    }
    ...
    {
        return $this->hasMany(DetalleLiquidacion::class, ['liq_id' => 'liq_id']);
    }
    ...
    {
        return $this->hasMany(FacturaLiquidacion::class, ['liq_id' => 'liq_id']);
    }
