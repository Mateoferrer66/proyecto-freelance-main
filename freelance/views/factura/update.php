...
$this->title = 'ACTUALIZAR FACTURA: ' . $model->fac_numero;
$this->params['breadcrumbs'][] = ['label' => 'Facturas', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->fac_numero, 'url' => ['view', 'fac_id' => $model->fac_id]];
...
<div class="page-content">
    <h6 class="mb-0 text-uppercase">ACTUALIZAR FACTURA <dl>* Datos obligatorios</dl></h6>
    <hr/>
    <div class="row">
            ...
            <div class="card border-top border-0 border-4 border-white">
                <div class="card-body p-5">
                    ...
                    <div id="datos-cliente" class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <?= $form->field($model, 'fac_situacion', [
                    ...
                    <div class="col-md-12 d-flex gap-2">
                        ...
                        <?= Html::button($model->fac_aprobada ? '<i class="bx bx-shield-quarter"></i> Desaprobar' : '<i class="bx bx-check-shield"></i> Aprobar', [
