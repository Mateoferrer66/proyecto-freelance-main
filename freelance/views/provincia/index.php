    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $.pjax.reload({container: '#provincia-pjax', async: false});
            } else {
...
<div class="provincia-index">
    ...
    <div class="mb-3" style="margin-top:20px;">
        <?= Html::a('<i class="bx bx-plus-medical"></i> Crear Provincia', ['create', 'view' => 'modal'], [
    ...
    <div class="col d-flex justify-content-between align-items-start">
        <h6 class="mb-0 text-uppercase">
            Provincias <span class="badge bg-warning text-dark"><?= $dataProvider->getTotalCount() ?></span>
        </h6>
    </div>
    ...
    <div class="container">
        ...
        <?php Pjax::begin(['id' => 'provincia-pjax']); ?>
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'delete' => fn($url, $model) => Html::a('<i class="bx bx-trash"></i>', $url, [
                            'title' => "Eliminar '{$model->prv_nombre}'",
                            'class' => 'btn btn-danger btn-sm',
                            'data-confirm' => "¿Eliminar la provincia '{$model->prv_nombre}'?",
                            'data-method' => 'post',
                            'data-pjax' => '1'
                        ]),
                    ],
