...
$this->title = 'EDITAR USUARIO: ' . $model->usu_nombre;
$this->params['breadcrumbs'][] = ['label' => 'Usuarios', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->usu_nombre, 'url' => ['view', 'usu_id' => $model->usu_id]];
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <?= $form->field($model, 'usu_password', [
                                'template' => "<label>Contraseña (dejar en blanco para no cambiar)</label>\n{input}\n{hint}\n{error}",
                            ])->passwordInput(['maxlength' => true, 'class' => 'form-control mb-3']) ?>
                        </div>
                        <div class="col-md-4">
