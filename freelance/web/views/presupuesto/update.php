    ...
    function addConceptRow(data){
        ...
        var $tr = $(
            ...
            '<td>'+ 
                ...
                '</select>'+ 
            '</td>'+ 
            '<td><input type="text" name="DetallePresupuesto['+idx+'][dtp_descripcion]" class="form-control row-descripcion" value="'+(data.dtp_descripcion||"")+'"></td>'+ 
            '<td><input type="number" step="0.01" name="DetallePresupuesto['+idx+'][dtp_iva]" class="form-control row-iva" value="'+(data.dtp_iva||0)+'"></td>'+ 
